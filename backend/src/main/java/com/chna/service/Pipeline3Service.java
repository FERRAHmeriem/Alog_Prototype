 ...
 * records the reception in the audit trail, and persists locally (Smart Fetching).
 *
...
public class Pipeline3Service {
     ...
     * After this pipeline completes, the FHIR resource is displayed in Node A's timeline.
     *
    ...
    public PipelineContext execute(FhirResponse incomingResponse, FhirRequest originalRequest) {
        ...
        // In Pipeline 3, the "request" object re-uses the original request token for re-verification
